                        ...
                        <tbody>
                            <tr>
                                <td align="center" valign="middle">
                                    <img src="http://localhost/tiketting/assets/images/DD.png" style="padding-top:48px;height: auto;width: 10rem;" class="CToWUd" data-bit="iit">
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody>
                                                        ...
                                                        <div style="padding-top:38px;background:#ffffff">
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td align="center" valign="top">
                                                                            <h1 style="font-weight:normal;font-size:30px;color:#434343;margin:0px;padding:0px 16px"> Tiket Event Anda telah terbit! </h1>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left" valign="top" style="padding:0px 16px">
                                                                            <div style="width:100%;height:38px;display:block"></div>
                                                                            <h3 style="font-size:16px;margin:0px;padding:0px;color:#434343;font-weight:bold"><strong>Yth. Sandy Dwi Laksana Putra,</strong></h3>
                                                                            <div style="width:100%;height:28px;display:block"></div>
                                                                            <p style="line-height:25px;font-size:16px;padding:0px;margin:0px">Pembelian tiket event Anda telah sukses dikonfirmasi.</p><br>
                                                                            <p style="line-height:25px;font-size:16px;padding:0px;margin:0px">Tiket event dan bukti pembelian Anda terdapat dalam lampiran.</p>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td align="left" valign="top" width="100%" style="padding-top:10px;padding-bottom:10px">
                                                                            <h2 style="font-size:16px;line-height:16px;font-weight:bold;width:100%;margin:0px;padding:0px;margin-top:10px">Kanpa Fest</h2>
                                                                            <p style="font-size:15px;color:#737374;margin:0px;padding:0px;margin-bottom:5px">Alun - Alun Kab. Semarang | Kab. Semarang | 01-10-2014 | 19:00</p>
                                                                            <p style="font-size: 15px;color: #1ba0e2;margin:0px;padding:0px;font-style: italic;">Tiket Reguler 1x </p>
                                                                            <p style="font-size: 15px;color: #1ba0e2;margin:0px;padding:0px;font-style: italic;">Tiket VIP 1x </p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" style="width:100%">
                                                                            <div style="padding:0 16px">
                                                                                <p style="font-size:14px;margin-top:15px"> Dipesan dan dibayarkan oleh:<br>
                                                                                    <span style="font-weight:bold;font-size:16px;color:#1ba0e2">Sandy Dwi Laksana Putra</span>
                                                                                </p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:20px;margin-bottom:20px">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" style="width:50%;margin:0px;padding:0px;padding-bottom:3px" valign="top">
                                                                                <p style="font-size:13px;margin:0px;padding:0px"> : 6530XH0580</p>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left" style="width:50%;margin:0px;padding:0px;padding-bottom:3px" valign="top">
                                                                            ...
                                                                            <td align="left" style="width:50%;margin:0px;padding:0px;padding-bottom:3px" valign="top">
                                                                                <p style="font-size:13px;margin:0px;padding:0px"> : BCA</p>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left" style="width:50%;margin:0px;padding:0px;padding-bottom:3px" valign="top">
                                                                            ...
                                                                            <td align="left" style="width:50%;margin:0px;padding:0px;padding-bottom:3px" valign="top">
                                                                                <p style="font-size:13px;margin:0px;padding:0px"> : Rp. 100.000 </p>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left" style="width:50%;margin:0px;padding:0px;padding-bottom:3px" valign="top">
                                                                            ...
                                                                            <td align="left" style="width:50%;margin:0px;padding:0px;padding-bottom:3px" valign="top">
                                                                                <p style="font-size:13px;margin:0px;padding:0px"> : 10-10-2024 </p>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" style="background:#e6eaed;padding-bottom:16px;width:100%;max-width:600px;border-bottom:1px solid #dadada">
                                                    <p style="color:#8f8f8f;font-size:12px;letter-spacing:0.5px;line-height:20px;text-align:center">Email ini hanya ditujukan untuk Sandy Dwi Laksana Putra, karena Anda telah melakukan pemesanan melalui Wisdil.com.</p>
                                                </td>
                                            </tr>
                                            <tr>
