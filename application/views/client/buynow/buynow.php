        ...
        <div class="card-body p-1" style="    background: #00000008;">
            <div class="row">
                <div class="col-lg-1 col-md-2 col-3">
                    ...
                    <img src="<?= base_url('upload/event/' . $data->poster); ?>" alt="" class="img-fluid"
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tgl_lahir[]" required
                                        class="form-control tgl-lahir tgl-lahir-<?= $no; ?>">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <select class="select2 form-control select-kota kota-<?= $no; ?>" name="kota[]"
                                        required>
            ...
            <div class="card-body pt-2 pb-2" style="background: #80808012;">
                ...
                <div class="row bg-white">
                    ...
                    <div class="col-6">
                        ...
                        <?php } else { ?>
                        <span class="medium font-weight-bold float-right">Rp.
                            <?= number_format($total + $fee, 0, ',', '.'); ?></span>
                        <?php } ?>
                    </div>
                </div>
                <div class="row">
                    ...
                    <button id="btn-submit-login" type="button" class="col-12 btn bg-w-orange"
