...
<section class="container mt-4">
    ...
    <div class="card box-shadow card-info-tiket-sold mb-1">
        <div class="card-body" style="padding: 4px 10px;">
            <span><span class="medium font-weight-bold">Sorry !</span> <span>Ticket : <span
                        class="font-weight-bold"><?= $rows->kategori_price; ?></span> ready stock ticket <span
                        class="font-weight-bold"> Sold Out</span></span></span>
        </div>
    </div>
    <?php } else { ?>
    <div class="card box-shadow card-info-tiket mb-1">
        <div class="card-body" style="padding: 4px 10px;">
            <span><span class="medium font-weight-bold">Sorry !</span> <span>Ticket : <span
                        class="font-weight-bold"><?= $rows->kategori_price; ?></span> ready stock ticket <span
                        class="font-weight-bold"> <?= $rows->stock_tiket - $rows->gratis; ?> x</span></span></span>
        </div>
    </div>
    <?php
                    } ?>
    ...
    <div class="card box-shadow">
        <div class="card-body p-1" style="    background: #00000008;">
            <ul class="mb-0" style="display: flex;">
                <li>
                    <img src="<?= base_url('assets'); ?>/images/poster.png" alt="" class="img-fluid"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="small mb-0"><i class="fa fa-ticket"></i><?= $rows->kategori_price; ?>
                                        x<?= $count; ?></p>
                                    <?php
                                            }
                                        }
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label class="fancy-checkbox float-right">
                                    <input type="checkbox" name="checkbox" class="ceklis-same-regis"
                                        data-parsley-multiple="checkbox" value="<?= $no; ?>">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email[]" id="email" required=""
                                        class="form-control email-<?= $no; ?>" value="">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama[]" id="nama" required=""
                                        class="form-control nama-<?= $no; ?>">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Tgl lahir</label>
                                    <input type="text" name="tgl_lahir[]" id="tgl-lahir" required=""
                                        class="form-control tgl-lahir-<?= $no; ?>">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <label class="fancy-radio">
                                        <input type="radio" id="gender-male-<?= $no; ?>"
                                            class="gender gender-<?= $no; ?>" data-no="<?= $no; ?>" value="male">
                                        <span><i></i>Male</span>
                                    </label>
                                    <label class="fancy-radio">
                                        <input type="radio" id="gender-female-<?= $no; ?>"
                                            class="gender gender-<?= $no; ?>" data-no="<?= $no; ?>" value="female">
                ...
                <div class="card mb-0">
                    <div class="card-header p-2">
                        <div class="row">
                            <div class="col">
                                <span class="span-no"><?= $span_no++; ?></span>
                                <span><?= $rows->kategori_price; ?> <sup class="sup-no"><?= $x; ?></sup> <sup
                                        class="sup-no">Free Ticket</sup></span>
                                <input type="text" name="id_price[]" value="<?= $rows->id_price; ?>" hidden>
                                <input type="text" name="code[]" value="<?= $x; ?>" hidden>
        ...
        <div class="card box-shadow">
            ...
            <div class="card-body pt-2 pb-2" style="background: #80808012;">
                ...
                <div class="row">
                    ...
                    <button id="btn-submit-login" class="col-12 btn bg-w-orange"
                        onclick="submitWithLoading('btn-submit-login')">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col" style="text-align-last: center;display: grid;">
                                <span class="notif-call-log bg-w-blue text-light" style="border-radius: 3px;">Passwod
                                    akun berhail di tambahkan</span>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" id="btn-close-modal" class="btn btn-danger"
