                    ...
                    <div class="info-tgl-event-b">
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-right: 15px;padding-left: 4px;"><i
                                            class="fa-solid fa-location-dot"></i></td>
                            ...
                            <li class="border-cate-tiket box-shadow mt-2">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="kategori_tiket[]" value="<?= $data->id_price; ?>"
                                            hidden>
                                        <span class="medium font-weight-bold">Rp.
                                            <?= number_format($data->harga, 0, ',', '.'); ?>,-</span>
                                    </div>
                                    <div class="col-6 pt-2">
                                        <button id="btn-add-tiket<?= $data->id_price; ?>"
                                            class="btn bg-w-blue text-light float-right btn-add-tiket plus"
                                            data-tiket="<?= $data->id_price; ?>"
                                            data-harga="<?= $data->harga; ?>">Add</button>
                                        <div id="count-tiket<?= $data->id_price; ?>" class="input-group mb-3" hidden>
                                            <div class="input-group-prepend minus" data-harga="<?= $data->harga; ?>"
                                                data-tiket="<?= $data->id_price; ?>">
                                                <i class="fa fa-minus btn btn-outline-secondary"
                                                    style="padding-top: 11px; border: 1px solid #dce9f4;"></i>
                                            </div>
                                            <input type="text" class="form-control input-count" name="count_tiket[]"
                                                placeholder="" aria-label="" aria-describedby="basic-addon1" value="0"
                                                readonly>
                                            <div class="input-group-prepend plus" data-harga="<?= $data->harga; ?>"
                                                data-status="<?= $data->status_bundling; ?>"
                                                data-tiket="<?= $data->id_price; ?>">
                                                <i class="fa fa-plus btn btn-outline-secondary"
                                                    style="padding-top: 11px; border: 1px solid #dce9f4;"></i>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-footer card-footer-tiket-detail">
                        <div class="row">
                            ...
                            <div class="col-6 pt-2">
                                ...
                                <button id="checkout" class="btn bg-w-orange float-right btn-checkout"
                                    data-toggle="modal" data-target="#defaultModal" disabled>Checkout</button>
                                <?php
                                } else { ?>
                                <button id="btn-submit" class="btn bg-w-orange float-right btn-checkout"
