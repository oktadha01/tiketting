<div id="left-sidebar" class="sidebar">
    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            <img src="<?= base_url('assets'); ?>/images/user/<?php echo $userdata->fot_profil; ?>" class="rounded-circle user-photo" alt="User Profile Picture">
            <div class="dropdown">
                <span>Welcome,</span>
                <a href="javascript:void(0);" class=" user-name"><strong><?= $this->session->userdata('userdata')->agency; ?></strong></a>
            </div>
            <hr>
        </div>
                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu li_animation_delay">
                            ...
                            <li class="menu">
                                <a href="<?= site_url('Event'); ?>" class=""><i class="fa fa-file-movie-o "></i><span>Event</span></a>
                            </li>
                            <li class="menu">
                                <a href="<?= site_url('Perform'); ?>" class=""><i class="fa fa-weibo"></i><span>Perform</span></a>
                            </li>
                            <li class="menu">
                                <a href="<?= site_url('Prices'); ?>" class=""><i class="fa fa-money"></i><span>Prices</span></a>
                            </li>
                            <li class="menu">
                            ...
                            <li class="menu">
                                <a href="<?= site_url('Banner_upload'); ?>" class=""><i class="fa fa-flag"></i><span>Banner</span></a>
                            </li>
                            <li class="menu">
                            ...
                            <li class="menu active">
                                ...
                                <ul class="submenu">
                                    <li><a href="<?= site_url('User/user_adm'); ?>" class="<?= ($this->uri->segment(1) == 'User/user_adm') ? 'active' : ''; ?>">
                                            User</a>
                                    </li>
                                    <li><a href="<?= site_url('Xendit'); ?>" class="<?= ($this->uri->segment(1) == 'Xendit') ? 'active' : ''; ?>">API
                                            Xendit</a></li>
                                </ul>
                            </li>
                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu li_animation_delay">
                            ...
                            <li class="menu">
                                <a href="<?= site_url('Scan_tiket'); ?>" id="scanTiketButton" class="">
                                    <i class="fa fa-ticket"></i><span>Scan Tiket</span>
                                </a>
                            </li>
                            <li class="menu">
                                <a href="<?= site_url('Scan_tiket/data_scan'); ?>" class="">
            ...
            <div class="tab-content padding-0">
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu li_animation_delay">
                            <li class="menu">
                                <a href="<?= site_url('Scan_tiket'); ?>" id="scanTiketButton" class=""><i class="fa fa-qrcode"></i><span>Scan Tiket</span>
                                </a>
                            </li>
                            <!-- <li class="menu">
