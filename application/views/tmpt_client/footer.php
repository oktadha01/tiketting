<footer class="footer bg-w-blue pt-12 ">
    <div class="container">
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <ul style="display: flex;">
                <li class="col text-center">
                    <i class="fa-brands fa-whatsapp bg-w-orange bg-size-icon"></i>
                </li>
                <li class="col text-center">
                    <i class="fa-brands fa-instagram bg-w-orange bg-size-icon"></i>
                </li>
                <li class="col text-center">
                    <i class="fa-brands fa-tiktok bg-w-orange bg-size-icon"></i>
                </li>
                <li class="col text-center">
                    <i class="fa-brands fa-youtube bg-w-orange bg-size-icon"></i>
                </li>
            </ul>
        </div>
        <hr>
